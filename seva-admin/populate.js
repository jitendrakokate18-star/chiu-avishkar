...
for (const [filename, newContent] of Object.entries(filesToUpdate)) {
    ...
    if (fs.existsSync(filepath)) {
        ...
        // Find the placeholder card and replace it
        // The placeholder is usually:
        // <div class="card p-6 text-center text-secondary">
        //   <p>... will be implemented here.</p>
        // </div>
        const placeholderRegex = /<div class="card p-6 text-center text-secondary">[\s\S]*?<\/div>/i;
        content = content.replace(placeholderRegex, newContent);
